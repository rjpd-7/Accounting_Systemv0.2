...
urlpatterns = [
     ...
     path('admin/sections/create/', views.admin_create_student_section, name='create_student_section'),
     path('admin/sections/assign/', views.admin_assign_student_sections_bulk, name='assign_student_sections_bulk'),
     path('admin/sections/assign-account-groups/', views.admin_assign_account_groups_to_section, name='assign_account_groups_to_section'),
